...
return (
	<div className="relative min-h-screen flex flex-col items-center justify-between overflow-hidden pt-8 px-7 bg-[#FAF9F9]">
					...
					open && (
						<motion.div
							...
							<div className="flex flex-col gap-5 items- justify-center w-fit ">
								...
								<Link href="/Contact" className=" text-[#E6B655]  w-fit font-semibold h-fit text-base" style={CairoFont.style}>
									Contact
								</Link>
							</div>
		...
		<div className="grid  grid-cols-4 mt-[100px] gap-[38px] xl:w-[1100px] w-full">
