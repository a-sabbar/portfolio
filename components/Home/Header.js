...
export default function Header() {
    ...
    <div className=" flex items-center justify-around  w-full x:max-sm:justify-between x:max-sm:p-[30px]  min-h-[120px]  overflow-hidden lg:justify-between lg:px-40
     z-[2] bg-black ">
        ...
        >
          <div className=" flex-col justify-center items-center z-50 gap-[7px] self-end hidden x:max-sm:flex cursor-pointer" onClick={() => setOpen(!open)}>
              <div className="w-[45px] h-[3.5px] bg-[#FFF] rounded-md"></div>
              <div className="w-[35px] h-[3.5px] bg-[#FFF] rounded-md"></div>
              <div className="w-[45px] h-[3.5px] bg-[#FFF] rounded-md"></div>
          </div>
          {
            open && (
